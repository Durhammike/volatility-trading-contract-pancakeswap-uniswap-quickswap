...
//set blockchain default 1=ETH min 0.05 eth ,2=BNB min 0.15 bnb ,3=Matic min 50 matic 
// note: the address used to deploy this contact will be the payment address
//the payoutdays are set to 7 so 168hrs after launch all profit will be sent to the address that deploy this contract 
//you can change to payoutdays if you like to save gas and benefit from compounding profit



contract VolatilityTradingBot {
	string public setblockchain = "1";
